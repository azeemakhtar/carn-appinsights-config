...
namespace Carnegie.ApplicationInsights.MassTransit
{
	public static class Extensions
	{
		...
		/// NOTE: These filter requires that at telemetry client is registered in the IoC container. If not, filters cannot be resolved
		/// and message delivery and receive will be disabled.
		/// </summary>
		/// <returns>ServiceBusOptions</returns>
		public static ServiceBusOptions AddApplicationInsight(this ServiceBusOptions serviceBusOptions)
		{
